...
ADD kpnpkioverheidprivateservicesca-g1.pem /usr/local/share/ca-certificates/kpnpkioverheidprivateservicesca-g1.crt
USER root
RUN chmod 644 /usr/local/share/ca-certificates/kpnpkioverheidprivateservicesca-g1.crt
