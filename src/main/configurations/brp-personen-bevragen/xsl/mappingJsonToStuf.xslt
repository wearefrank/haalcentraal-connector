                    ...
                    <BG:object>
                        ...
                        <xsl:if
                            ...
                            <BG:inp.indicatieGeheim>
                                <xsl:choose>
                                    <xsl:when test="./geheimhoudingPersoonsgegevens/text() != ''">
                            ...
                            <BG:verblijfsadres>
                                ...
                                <xsl:if
                                    ...
                                    <BG:wpl.identificatie>
                                        <xsl:choose>
                                            <xsl:when
                                                test="./verblijfplaats/identificatiecodeAdresseerbaarObject/text() != ''">
                                                <xsl:value-of
                            ...
                            <BG:sub.verblijfBuitenland>
                                <xsl:if
                                    ...
                                    <BG:lnd.landcode>
                                        <xsl:choose>
                                            <xsl:when
                                                test="./verblijfplaats/verblijfBuitenland/land/code/text() != ''">
                                                <xsl:value-of
                                ...
                                <xsl:if
                                    ...
                                    <BG:sub.adresBuitenland1>
                                        <xsl:choose>
                                            <xsl:when
                                                test="./verblijfplaats/verblijfBuitenland/adresRegel1/text() != ''">
                                                <xsl:value-of
                                ...
                                <xsl:if
                                    ...
                                    <BG:sub.adresBuitenland2>
                                        <xsl:choose>
                                            <xsl:when
                                                test="./verblijfplaats/verblijfBuitenland/adresRegel2/text() != ''">
                                                <xsl:value-of
                                ...
                                <xsl:if
                                    ...
                                    <BG:sub.adresBuitenland3>
                                        <xsl:choose>
                                            <xsl:when
                                                test="./verblijfplaats/verblijfBuitenland/adresRegel3/text() != ''">
                                                <xsl:value-of
                                ...
                                <BG:inp.heeftAlsEchtgenootPartner>
                                    ...
                                    <xsl:if
                                        ...
                                        <BG:inp.soortVerbintenis>
                                            <xsl:choose>
                                                <xsl:when test="./soortVerbintenis/text() !=''">
                            ...
                            <xsl:if
                                ...
                                <BG:inp.heeftAlsOuders>
                                    ...
                                    <xsl:if
                                        ...
                                        <BG:ouderAanduiding>
                                            <xsl:choose>
                                                <xsl:when test="./ouderAanduiding/text() !=''">
