            ...
            <BG:antwoord>
                <BG:object>
                    ...
                    <BG:aanduidingNaamgebruik>
                            <xsl:value-of
                                select="./naam/aanduidingNaamgebruik" />
                        </BG:aanduidingNaamgebruik>
                    ...
                    <BG:inp.redenVerkrijging>
                            ...
                            <omschrijving>
                                <xsl:value-of
                                    select="./nationaliteit/redenOpname/omschrijving" />
                            </omschrijving>
                        </BG:inp.redenVerkrijging>
                    <!-- <BG:inOnderzoek>
                            <aanduidingBijzonderNederlanderschap>
                                <xsl:value-of
                                    select="./nationaliteit/inOnderzoek[/elementnaam = aanduidingBijzonderNederlanderschap]/aanduidingBijzonderNederlanderschap" />
                            </aanduidingBijzonderNederlanderschap>
                            <nationaliteit>
                                <xsl:value-of
                    ...
                    <BG:inp.overlijdenplaats>
                            <code>
                                <xsl:value-of select="./overlijden/plaats/code" />
                            </code>
                            <omschrijving>
                    ...
                    <BG:inp.overlijdenLand>
                            ...
                            <omschrijving>
                                <xsl:value-of select="./overlijden/land/omschrijving" />
                            </omschrijving>
                        </BG:inp.overlijdenLand>
                    ...
                    <BG:verblijfsadres>
                            ...
                            <BG:wpl.identificatie>
                                <xsl:value-of
                                    select="./verblijfplaats/identificatiecodeAdresseerbaarObject" />
                            </BG:wpl.identificatie>
                            <BG:wpl.woonplaatsNaam>
                                <xsl:value-of select="./verblijfplaats/woonplaatsnaam" />
                            </BG:wpl.woonplaatsNaam>
                    ...
                    <BG:sub.verblijfBuitenland>
                            <xsl:if
                                test="string-length(./verblijfplaats/verblijfBuitenland/adresRegel1) !=0">
                                <BG:sub.adresBuitenland1>
                                    <xsl:value-of
                                        select="./verblijfplaats/verblijfBuitenland/adresRegel1" />
                                </BG:sub.adresBuitenland1></xsl:if>
                            <xsl:if
                                test="string-length(./verblijfplaats/verblijfBuitenland/adresRegel2) !=0">
                                <BG:sub.adresBuitenland2>
                                    <xsl:value-of
                                        select="./verblijfplaats/verblijfBuitenland/adresRegel2" />
                                </BG:sub.adresBuitenland2></xsl:if>
                            <xsl:if
                                test="string-length(./verblijfplaats/verblijfBuitenland/adresRegel3) !=0">
                                <BG:sub.adresBuitenland3>
                                    <xsl:value-of
                                        select="./verblijfplaats/verblijfBuitenland/adresRegel3" />
                                </BG:sub.adresBuitenland3></xsl:if>
                            <vertrokkenOnbekendWaarheen>True</vertrokkenOnbekendWaarheen>
                            <BG:lnd.landcode>
                                <code>
                                    <xsl:value-of
                                        select="./verblijfplaats/verblijfBuitenland/land/code" />
                                </code>
                                <omschrijving>
                                    <xsl:value-of
                                        select="./verblijfplaats/verblijfBuitenland/land/omschrijving" />
                                </omschrijving>
                            </BG:lnd.landcode>
                    ...
                    <BG:Verblijfsplaats>
                            ...
                            <!-- <StUF:InOnderzoek>
                                ...
                                <huisnummertoevoeging>
                                    <xsl:value-of
                                        select="./verblijfplaats/inOnderzoek[/groepsnaam = Verblijfsplaats/groepsnaam]/huisnummertoevoeging" />
                                </huisnummertoevoeging>
                                <identificatiecodeNummeraanduiding>
                                    <xsl:value-of
                                        select="./verblijfplaats/inOnderzoek[/groepsnaam = Verblijfsplaats/groepsnaam]/identificatiecodeNummeraanduiding" />
                                </identificatiecodeNummeraanduiding>
                                <identificatiecodeAdresseerbaarObject>
                                    <xsl:value-of
                                        select="./verblijfplaats/inOnderzoek[/groepsnaam = Verblijfsplaats/groepsnaam]/identificatiecodeAdresseerbaarObject" />
                                </identificatiecodeAdresseerbaarObject>
                                <landVanwaarIngeschreven>
                                    <xsl:value-of
                                        select="./verblijfplaats/inOnderzoek[/groepsnaam = Verblijfsplaats/groepsnaam]/landVanwaarIngeschreven" />
                                </landVanwaarIngeschreven>
                                <locatiebeschrijving>
                                    <xsl:value-of
                    ...
                    <!-- <BG:inOnderzoek>
                            <indicatieCurateleRegister>
                                <xsl:value-of
                                    select="./gezagsverhouding/inOnderzoek[/groepsnaam = Gezagsverhouding/groepsnaam]/indicatieCurateleRegister" />
                            </indicatieCurateleRegister>
                            <indicatieGezagMinderjarige>
                                <xsl:value-of
                                    select="./gezagsverhouding/inOnderzoek[/groepsnaam = Gezagsverhouding/groepsnaam]/indicatieGezagMinderjarige" />
                            </indicatieGezagMinderjarige>
