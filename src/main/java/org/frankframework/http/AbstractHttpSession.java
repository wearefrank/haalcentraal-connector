...
public abstract class AbstractHttpSession implements ConfigurableLifecycle, HasKeystore, HasTruststore, FrankElement {
	...
	private @Getter String resourceServer;
	...
	/** Resource server header to send to the tokenEndpoint. Only used when <code>tokenEndpoint</code> is specified */
	public void setResourceServer(String string) {
